export const recipeDummy = [
  ...
  }, 
  {
    ...
    instructions: [
      "First make the pizza dough by combining the flour, with some luke somr water", 
      "Once the dough is ready, keep it aside for a few hours, in the meantime work on the toppings", 
      "Make the pizza sauce by combining the tomato suace, oregano as well as cheese", 
      "Preheat the ovent to 240 degree C and keep the pizza for 40 mins", 
